        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              ...
              { label: 'ACT exam guide', to: '/entrance-exams/international/act/' },
              { label: 'LSAT exam guide', to: '/entrance-exams/international/lsat/' },
              { label: 'UCAT exam guide', to: '/entrance-exams/international/ucat/' },
              { label: 'LNAT exam guide', to: '/entrance-exams/international/lnat/' },
              { label: 'IELTS exam guide', to: '/entrance-exams/international/ielts/' },
              { label: 'PTE Academic exam guide', to: '/entrance-exams/international/pte/' },
              ...
              { label: 'CELPIP exam guide', to: '/entrance-exams/international/celpip/' },
              { label: 'OET exam guide', to: '/entrance-exams/international/oet/' },
